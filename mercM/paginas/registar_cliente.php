...
<html lang="pt-br">
        ...
        <main class="servicos container">
          <div class="centralizar">
               <form action="processa_cliente.php" method="post">
                 ...
                 <fieldset id="Dados Pessoais">  <legend>  <h2>Dados Pessoais cliente</h2> </legend><br>
  ...
  <fieldset > <legend>  <h2>endereco | celular</h2> </legend>
        ...
        <p><label for="nrCelular">nr de celular:</label><input type="number" name="nr_celular"   size="9" maxlength="9" placeholder="Digita nr de clular" class="setinf" required=""> </p>
