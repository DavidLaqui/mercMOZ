    ...
    <body>
        ...
        <div class="banner container">
            <div class="title">
                ...
                <h3> publique teus produtos online de forma facil e muito mais rapido! deixe teus produto mais pertos dos teus clientes.</h3>
            </div>
        ...
        <main class="servicos container">
          <div class="servicos">
            ...
            <div id=" content">
    <form method="post" action="processar_produto.php" enctype="multipart/form-data">
