...
<?php 
          include_once("../conexao.php");
               ...
               /* tentando criar FORMULARIO INVISIVEL*/
               echo "<form action='fazer_compra.php' method='post' enctype='multipart/form-data'>";
                   echo "<input type='text' name='id_cliente' value='".$id."' id='transparente' > ";
                  echo "<input type='text' name='id_produto' value='".$linha['id_produto']."' id='transparente'> ";
               /* FECHANDO O FORMULARIO INVISIVEL*/

                echo "<button type='submit' class='efeito efeito-1' >comprar</button>";
                echo"</form>";
                echo "</div>";
                echo "</article>";
                $control=$b;
