...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="banner container">
            ...
            <div class="buttons">
            <a href="admercMoz.php"><button class="btn btn-sobre bg-black radius"> voltar <i class="fa fa-question-circle"></i></button></a>
          </div>
        ...
        <main class="servicos container">
          <div class="centralizar">
               <form action="processa.php" method="post">
                 ...
                 <fieldset id="Dados Pessoais">  <legend>  <h2>Dados Pessoais</h2> </legend><br>
                          <p><label for="cnome">Nome Completo:</label><input type="text" name="tnome" id="cnome" size="45" maxlength="40" placeholder="Digita o Seu Nome Completo" class="setinf"></p>
                          <fieldset id="sexo"><legend> Sexo </legend><br>
                               <input type="radio" name="Tsexo" id="cmasculino" value="Masculino" /><label for="cmasculino">Masculino</label> 
                               <input type="radio" name="Tsexo" id="cfemenino" value="Femenino" /><label for="cfemenino">Femenino</label>
                         </fieldset><br>
                <p><label for="nrbi">Nr BI:</label><input type="text" name="nr_bi"  size="45" maxlength="40" placeholder="Digita o nr de BI" class="setinf" ></p>
              <p><label for="cdata">Data de Nascimento:</label><input type="date" class="setinf" name="data_nasc" /> </p>
              <p><label for="cdataEmissao">Data de emissao do BI:</label><input type="date" class="setinf" name="data_emissao" /> </p>
              </fieldset>
  
  <fieldset > <legend>  <h2>Dados da banca</h2> </legend>
         <p><label for="nr">Nr da banca:</label><input type="number" name="nr_banca" size="50" maxlength="5000" placeholder="Numero da banca" class="setinf"></p>
        <p><label for="nrCelular">nr de celular:</label><input type="number" name="nr_celular"   size="9" maxlength="9" placeholder="Digita nr de clular" class="setinf"> </p>
