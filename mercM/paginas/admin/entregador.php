  ...
  <tbody>
      ...
      <?php 
          include_once("../conexao.php");
              ...
              echo "<tr>";
              echo "<form action='Editar_entregador.php' method='post'>";
              echo "<input type='text' name='nr_bi' value='".$linha['nr_bi']."' id='transparente'> ";
              echo "<td> ".$t."</td> "; 
                echo "<td> <input type='text' name='nome' value='".$linha['nome']."'></td> "; 
                echo "<td><input type='text' name='nr_bi' value='".$linha['nr_bi']."' disabled></td> "; 
                echo " <td> <input type='text' name='sexo' value='".$linha['sexo']."'></td> ";
                echo " <td><input type='data' name='data_nasc' value='".$linha['data_nasc']."'></td> "; 
                echo " <td><input type='data' name='data_emisao' value='".$linha['data_emisao']."'></td> "; 
                echo " <td><input type='text' name='morada'value='".$linha['morada']."'></td> "; 
                echo " <td><input type='text' name='nr_celular' value='".$linha['nr_celular']."'> </td>";
                echo " <td><input type='text' name='nr_carta' value='".$linha['nr_carta']."'> </td>";
                echo " <td><input type='text' name='nr_matricula' value='".$linha['nr_matricula']."'> </td>";
                echo " <td>"."<button type='submit' class='efeito efeito-1' >Editar</button>"." </td>"; 
                echo " <td>"."<a href='eliminar_entregador.php?id=".$linha['nr_bi']."' type='button' class='efeito efeito-4'>Eliminar</a>"." </td>";  
                  echo "</tr>";
                  echo "</form>";
                  $t=$t+1;
               }
